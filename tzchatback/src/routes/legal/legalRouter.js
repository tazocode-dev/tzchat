...
router.post('/consents/agree', authMiddleware, controller.postConsentsAgree);

// GET /api/legal/agreements/me — 내 동의 현황 조회
router.get('/agreements/me', authMiddleware, controller.myAgreements);

// POST /api/legal/agreements/me/consent — (하위호환) 동의하기
router.post('/agreements/me/consent', authMiddleware, controller.postMyConsentLegacy);

// GET /api/legal/agreements/me/status — 필수 재동의 목록(pending) + 선택 동의 현황(optional)
router.get('/agreements/me/status', authMiddleware, controller.myAgreementStatus);
