<!-- src/components/05110_Membership/Page/purchaseMemPremium.vue -->
<template>
  <ion-page class="purchase-detail">
    <ion-header translucent="true">
      <ion-toolbar>
        <ion-title>구독 프리미엄회원</ion-title>
      </ion-toolbar>
    </ion-header>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-card class="option">
        <ion-card-header>
          <ion-card-title>프리미엄 회원 구독 (월)</ion-card-title>
        </ion-card-header>
        <ion-card-content>
          ...
          <ul class="benefits">
            <li>광고 제거</li>
            <li>하트·스타·루비 월 보너스</li>
            <li>우선 노출/프리미엄 전용 기능</li>
          </ul>
...
function subscribe () {
  // TODO: 구독 결제(정기결제) 연동
  console.log('subscribe: premium', { total, supply, vat })
}
</script>
