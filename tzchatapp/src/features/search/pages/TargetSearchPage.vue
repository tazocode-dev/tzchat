...
const SpeedMatchToggle = defineAsyncComponent(() => import('@/features/search/components/SpeedMatchToggle.vue'))
...
function initSocket() {
  try {
    ...
    //    users:* 계열(AllUsersPage와 공유되는 일반 추천 목록 실시간 갱신)은 그대로 유지한다.
