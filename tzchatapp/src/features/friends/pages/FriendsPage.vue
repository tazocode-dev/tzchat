...
// 탭별 페이지
import SpeedMatchResultsPage from '@/features/friends/pages/SpeedMatchResultsPage.vue'
...
const viewMap = {
  premium: SpeedMatchResultsPage,
  received: ReceivedFriendRequestsPage,
  sent: SentFriendRequestsPage,
  friends: FriendsListPage,
  blocks: BlockedUsersPage,
}
const currentView = computed(() => viewMap[currentTab.value] || ReceivedFriendRequestsPage)
